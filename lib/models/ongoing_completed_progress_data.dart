class OnGoingCompletedProgress {
  bool? success;
  List<OnGoingCompletedData>? data;

  OnGoingCompletedProgress({this.success, this.data});

  OnGoingCompletedProgress.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['data'] != null) {
      data = <OnGoingCompletedData>[];
      json['data'].forEach((v) {
        data!.add(OnGoingCompletedData.fromJson(v));
      });
    }
  }
...
class OnGoingCompletedData {
  ...
  OnGoingCompletedData.fromJson(Map<String, dynamic> json) {
