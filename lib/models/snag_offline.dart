class SnagDataOffline {
  List<Data>? data;

  SnagDataOffline({this.data});

  SnagDataOffline.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
...
class Data {
  ...
  DebetcontractorInfo? debetcontractorInfo;
  Category? category;
  Employee? employee;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    debetcontractorInfo = json['debetcontractorInfo'] != null
        ? DebetcontractorInfo.fromJson(json['debetcontractorInfo'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (createdBy != null) {
      data['createdBy'] = createdBy1!.toJson();
    }
    return data;
  }
}
...
class DebetcontractorInfo {
  ...
  DebetcontractorInfo.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    clientId = json['client_id'];
    projectId = json['project_id'];
    clientContractorId = json['client_contractor_id'];
