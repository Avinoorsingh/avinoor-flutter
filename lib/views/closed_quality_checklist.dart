...
class ClosedQualityCheckList extends StatefulWidget {
  ...
  @override
  State<ClosedQualityCheckList> createState() => _OpenedCheckListState();
}
...
class _OpenedCheckListState extends State<ClosedQualityCheckList> {
  final getCheckList = Get.find<GetClosedCheckList>();
    ...
    GetBuilder<GetClosedCheckList>(builder: (_){
     ...
     if(signInController.getClosedCheckListData!.new1!.isNotEmpty && subLocationName.isEmpty){
      for(int i=0;i<signInController.getClosedCheckListData!.new1!.length;i++){
       ...
       activityHead.add(signInController.getClosedCheckListData!.new1![i].activityHead);
       subLocationName.add(signInController.getClosedCheckListData!.new1![i].subLocationName);
       subSubLocationName.add(signInController.getClosedCheckListData!.new1![i].subSubLocationName);
       locationName.add(signInController.getClosedCheckListData!.new1![i].locationName);
       remark.add(signInController.getClosedCheckListData!.new1![i].remarks);
       dueDates.add(signInController.getClosedCheckListData!.new1![i].endDate);
       contractorNames.add(signInController.getClosedCheckListData!.new1![i].contractorName??"No Contractor");
