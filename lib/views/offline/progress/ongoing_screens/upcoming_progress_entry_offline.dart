...
class UpComingEntryOffline extends StatefulWidget {
  UpComingEntryOffline({Key? key, this.from, this.editModel }) : super(key: key);

 // ignore: prefer_typing_uninitialized_variables
 final from;
 dynamic editModel;
  @override
  State<UpComingEntryOffline> createState() => _SnagState();
}

class _SnagState extends State<UpComingEntryOffline>{
             ...
             ElevatedButton(
              ...
              onPressed:() async{
                ...
                mappedData['progress_data']=(
                  ...
                  try {
                    databaseProvider.insertUpcomingInsideOnGoingFormData(mappedData);
