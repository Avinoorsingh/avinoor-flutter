...
class SnagDetailOffline extends StatefulWidget {
  SnagDetailOffline({Key? key, this.from, this.snagModel }) : super(key: key);
 ...
 dynamic snagModel;
  ...
  @override
  State<SnagDetailOffline> createState() => _SnagState();
}

class _SnagState extends State<SnagDetailOffline> {
  late String subV="";
  late String subSubV="";
